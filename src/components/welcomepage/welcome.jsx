      ...
      <div className="column-container">
        <Link id="link" to="/questions" state={{ index: 0 }}>
          <div className="column-item">
            ...
            <div style={{background: '#fff1e9'}} className="img-div"><img className="img-out" src={htmlicon1} /></div>
        ...
        <Link id="link" to="/questions" state={{ index: 1 }}>
          <div className="column-item">
          <div style={{background: '#e0fdff'}}  className="img-div"><img className="img-out" src={htmlicon2} /></div>
            CSS
          </div>
        </Link>
        <Link id="link" to="/questions" state={{ index: 2 }}>
          <div className="column-item">
          <div style={{background: '#ebf0ff'}}  className="img-div"><img className="img-out" src={htmlicon3} /></div>
            JavaScript
          </div>
        </Link>
        <Link id="link" to="/questions" state={{ index: 3 }}>
          <div className="column-item">
          <div style={{background: '#f6e7ff'}}  className="img-div"><img className="img-out" src={htmlicon4} /></div>
            ACCESSIBILITY
          </div>
        </Link>
      </div>
